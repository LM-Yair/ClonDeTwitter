...
const CreateTweet = () => {
  return (
    <section className="CreateTemplateTweet">
      <div className='CreateTemplateTweet__Container--1'>
        <img
          className="CreateTemplateTweet__Image"
          src={userImg}
          alt="Perfil de Usuario"
        />
      </div>
      <div className='CreateTemplateTweet__Container--2'>
        <div className="CreateTemplateTweet__text">
          <input type="text" placeholder="¿Que esta pasando?" />
        </div>
        <div className="CreateTemplateTweet__Actions">
          <div className="CreateTemplateTweet__Action--Icons">
          ...
          <div className="CreateTemplateTweet__Actions--Submmit">
            <div>Twittear</div>
          </div>
        </div>
      </div>
